...
/*
 ...
 3) 자바언어로 작성되어 있어, 자바의 일반적인 특징을 모두 갖고 있다.
 4) 자동으로 스레딩 처리가 된다(동시 다발적인 클라이언트들의 요청에 대응하는것이 용이)
 */
...
public class Ex1_HelloAction extends HttpServlet {
	...
	protected void service(HttpServletRequest request, 
		...
		//url매핑이 호출되면 맨 처음 실행되는 메서드(service)
		//request : 요청 처리객체
		//response : 응답 처리객체
		...
		out.print("<body>");
			out.print("<h1>"+ ip + "님 환영합니다</h1>");//<--- PrintWriter를 통해서 화면에 결과를 출력
		out.print("</body>");
